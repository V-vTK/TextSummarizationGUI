...
const MatrixComponent = (props) => {
  ...
  return (
    <>
        ...
        <table style={{ borderCollapse: 'collapse' }}>
          ...
          <tbody>
            {matrix.map((row, rowIndex) => (
              <tr key={rowIndex}>
                <th style={{ border: '1px solid black', padding: '5px' }}>{`r${rowIndex + 1}`}</th>
      ...
      <p style={{ textAlign: "center", marginTop: "1vh", marginBottom: "0vh" }}>S2 = The second sentence</p>
      <p style={{ textAlign: "center", marginTop: "1vh", marginBottom: "0vh" }}>R1 = The first unique word</p>
      <p style={{ textAlign: "center", marginTop: "1vh", marginBottom: "0vh" }}>R2 = The second unique word</p>
    </>
  );
};
