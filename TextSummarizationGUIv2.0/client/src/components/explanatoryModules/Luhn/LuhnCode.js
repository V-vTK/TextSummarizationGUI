...
const LuhnCode = (props) => {
    const pCode = `# -*- coding: utf-8 -*-
    ...
    class LuhnSummarizer(AbstractSummarizer):
        ...
        def _get_significant_words(self, words):
            ...
            words = tuple(self.stem_word(w) for w in words if w not in self._stop_words) #significant_stems
