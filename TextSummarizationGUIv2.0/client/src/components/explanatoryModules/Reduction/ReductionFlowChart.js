...
const BoxArrowComponent = () => {
  return (
    <div style={containerStyle}>
      <div style={rowStyle}>
        ...
        <div style={{ ...boxStyle, backgroundColor: '#74B9FF' }} id="box2">
          ...
          <ul style={{ listStyle: "none", padding: 0, textAlign: "center" }}>
            ...
            <li style={{ marginBottom: '5px' }}>- Listing sentences as words</li>
          </ul>
        </div>
        <div style={arrowStyle}>
          <svg width="50" height="50" viewBox="0 0 50 50" style={{ transform: 'rotate(0deg)' }}>
        ...
        <div style={{ ...boxStyle, backgroundColor: '#55E6C1' }} id="box3">
          <h3 style={{ fontSize: "24px", marginBottom: '0px', textAlign: "center" }}>Similarity calculations</h3>
          <ul style={{ listStyle: "none", padding: 0, textAlign: "center" }}>
            <li style={{ marginBottom: '5px' }}>- Common words between sentence pairs</li>
          </ul>
        </div>
      </div>
      ...
      <div style={{ ...rowStyle, marginLeft: "20vw" }}>
        ...
        <div style={{ ...boxStyle, backgroundColor: '#A3CB38' }} id="box6">
          <h3 style={{ fontSize: "24px", marginBottom: '0px', textAlign: "center" }}>Calculating Ratings</h3>
          <ul style={{ listStyle: "none", padding: 0, textAlign: "center" }}>
            <li style={{ marginBottom: '5px' }}>- Based on the similarity method</li>
